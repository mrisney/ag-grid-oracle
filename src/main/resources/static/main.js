var columnDefs = [
  ...
  {headerName: 'Hierarchy', children: [
      {headerName: 'County', field: 'VCHCOUNTY', type: 'dimension', rowGroupIndex: 0, hide: true},
      {headerName: 'City', field: 'VCHCITY', type: 'dimension', rowGroupIndex: 1, hide: true},
      {headerName: 'Route', field: 'ROUTE', type: 'dimension', rowGroupIndex: 2, hide: true},
    ]},

  // some string values, that do not get aggregated
  {headerName: 'Attributes', children: [
    {headerName: 'MilePost', field: 'MILEPOST', width: 100, type: 'dimension',
...
EnterpriseDatasource.prototype.getRows = function (params) {
  ...
  httpRequest.open('POST', '/angular-crashes/getRows');
